...
elseif (rot >13 and rot<21) then --========================    PAGE 3    ======================  
...
pos = tab.x
 ...
 if rot==18 then -------------- VALEUR fall drag brake  /   curve 25
 ...
 if rot==19 then -------------- ACTIVATION limiteur DR bouton    /   Special Function CF11  / Logical switch  LS44 
...
case(94,46,model.getCustomFunction(10).active) -- case
   ...
   if rot==20 then -------------- VALEUR reglage mode enfant /   output 1 (ch2)
...
elseif (rot >20 and rot<27) then -- rot= 15 16 17 18  ========================    PAGE 4    ======================  
...
if rot == 21 then -- ROT point 3 de courbe
...
if rot == 22 then -- ROT point 4 de courbe
...
if rot == 23 then -- ROT point 5 de courbe
...
if rot == 24 then -- ROT point 6 de courbe
...
if rot == 25 then -- ROT point 7 de courbe
...
if rot == 26 then -- ROT point 8 de courbe
...
elseif (rot >26 and rot<30) then -- rot= 21 22 23  ========================    PAGE 5    ======================     
...
if rot == 27 then -- ROT point 5 de courbe
...
if rot == 28 then -- ROT point 6 de courbe
...
if rot == 29 then -- ROT point 7 de courbe
...
elseif (rot >29 and rot<32) then -- rot= 24  ========================    PAGE 6    ======================  
...
if rot == 30 then -- ROT point 2 et 5 de courbe
...
if rot == 31 then -- ROT point 3 et 4 de courbe
